...
export const PitchDeckSchema = z.object({
  ...
  opportunitySize: z.object({
    tam: z.string(),
    sam: z.string(),
    som: z.string(),
    description: z.string(),
  }),
  marketGrowthDrivers: z.object({
    rows: z.array(
      z.object({ trend: z.string(), marketEffect: z.string(), source: z.string() }),
    ),
  }),
  solution: z.object({
  ...
  team: z.object({
    members: z.array(
      z.object({ name: z.string(), role: z.string(), points: z.array(z.string()) }),
    ),
  }),
  impact: z.object({ points: z.array(z.string()), vision: z.string() }),
  ask: z.object({ sectionTitle: z.string(), paragraph: z.string() }),
  thankYou: z.object({
    message: z.string(),
