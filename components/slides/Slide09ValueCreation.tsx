...
export function Slide09ValueCreation({
  data,
  companyName,
}: {
  data: PitchDeckJSON["valueCreation"];
  companyName: string;
}) {
  return (
    <SlideWrapper>
      <div className="absolute inset-0 bg-white">
        ...
        <div className="absolute left-[8%] top-[18%] w-[36%]">
          ...
          <p className="text-[1.2vw] font-light text-gray-500 leading-relaxed">{data.paragraph}</p>
        </div>
